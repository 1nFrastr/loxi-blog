---
title: 产品设计：Roadmate 近场设备 Playground——圆形信标与碰一碰配对
tags:
  - Roadmate
  - 硬件交互
  - 产品设计
...
线下破冰难，往往不是不会说话，而是不知道该找谁、该往哪边走。Roadmate（路友）想验证的是：用 AI 先筛出同频兴趣，再用一枚可佩戴的近场 Tag，把「匹配」变成灯光、方向和靠近确认——全程尽量不掏手机。

当前还是 Web 拟物原型：拖动主控靠近同频设备，靠灯环、方向箭头和重叠充能完成配对。本文整理设备外形与近场交互的设计取舍。
...
推断侧细节见 [兴趣推断设计](/article/8710aee9/)。
